...
{
    [ExportCodeFixProvider("OutParametersDiagnosticCodeFixProvider", LanguageNames.CSharp), Shared]
    public class OutParametersDiagnosticCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> GetFixableDiagnosticIds()
        {
            return ImmutableArray.Create(OutParametersDiagnosticAnalyzer.DiagnosticId);
        }
        ...
        public sealed override async Task ComputeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterFix(
                CodeAction.Create("Reorder parameters", c => this.ReorderParameters(context.Document, root, parameterList, c)),
                context.Diagnostics);
        }
